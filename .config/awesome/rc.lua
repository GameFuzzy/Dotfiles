...
local theme_path = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "fuzzy")
...
screen.connect_signal("property::geometry", function() awful.spawn.with_shell("./wallpaper.sh") end)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey            }, "XF86AudioLowerVolume", function () awful.spawn("playerctl --player=spotify previous") end,
              {description = "switch to previous track in Spotify", group = "media"}),
    awful.key({ modkey            }, "XF86AudioRaiseVolume", function () awful.spawn("playerctl --player=spotify next") end,
              {description = "switch to next track in Spotify", group = "media"}),
    awful.key({ modkey            }, "XF86AudioMute", function () awful.spawn("playerctl --player=spotify play-pause") end,
...
awful.rules.rules = {
    ...
    { rule_any = {
      ...
      -- JetBrains fix, see https://github.com/awesomeWM/awesome/issues/2204
      {
          rule = {
            class = "jetbrains-.*",
